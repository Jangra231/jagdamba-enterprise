      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full text-center">
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="grid grid-cols-3 gap-8 sm:gap-16 border-t border-b border-[#0a0a0a]/10 py-6 my-4 w-full max-w-2xl">
            <div>
              <p className="font-display font-black text-2xl sm:text-3xl text-[#0A0A0A]">3+ Yrs</p>
              <p className="text-[10px] sm:text-xs text-brand-muted font-bold uppercase tracking-wider font-mono mt-1">Since 2023</p>
            </div>
            <div>
              <p className="font-display font-black text-2xl sm:text-3xl text-[#0A0A0A]">98%</p>
              <p className="text-[10px] sm:text-xs text-brand-muted font-bold uppercase tracking-wider font-mono mt-1">Retention</p>
            </div>
            <div>
              <p className="font-display font-black text-2xl sm:text-3xl text-[#0A0A0A]">50+ Hubs</p>
              <p className="text-[10px] sm:text-xs text-brand-muted font-bold uppercase tracking-wider font-mono mt-1">Global Sourcing</p>
            </div>
          </div>
