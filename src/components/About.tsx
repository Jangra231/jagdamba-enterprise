...
export default function About({
  ...
  const [activeTimelineIdx, setActiveTimelineIdx] = useState(
  ...
  return (
    <section
      id="about"
      className="py-24 bg-[#FCFCFC]/50 relative overflow-hidden"
      ref={containerRef}
    >
      {/* Decorative Overlays */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-left mb-16 max-w-3xl">
          ...
          <p className="mt-4 text-gray-700 text-sm sm:text-base leading-relaxed">
            For over 3 years, Jagdamba Enterprises has been driven by a simple
            belief — that business can be a force for good. What began as a
            vision to deliver quality solutions has grown into a diversified
            enterprise creating sustainable value across industries and
          ...
          <div className="lg:col-span-5 relative rounded-3xl overflow-hidden bg-white border border-[#0A0A0A]/10 p-8 flex flex-col justify-between group shadow-sm">
            ...
            <div>
              ...
              <h3 className="font-display font-extrabold text-2xl text-[#0A0A0A] mt-4">
                ...
                <span className="text-[#0A0A0A]/60 font-bold">
                  Powering Progress.
                </span>
              </h3>
            ...
            <div className="my-8 relative flex items-center justify-center p-4">
              <svg
                className="w-full max-w-70 h-40 text-gray-200"
                viewBox="0 0 100 50"
                fill="none"
              >
                <path
                  d="M 10 50 L 10 20 L 25 10 L 40 20 L 40 50 Z"
                  fill="currentColor"
                  opacity="0.5"
                />
                <path
                  d="M 25 50 L 25 12 L 35 5 L 45 12 L 45 50 Z"
                  fill="currentColor"
                  opacity="0.8"
                />
                <path
                  d="M 50 50 L 50 25 L 65 15 L 80 25 L 80 50 Z"
                  fill="currentColor"
                  opacity="0.3"
                />
                ...
                {/* Accent curves */}
                <path
                  d="M 5 45 Q 30 15, 95 45"
                  stroke="#0A0A0A"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                />
                <path
                  d="M 5 40 Q 30 10, 95 40"
                  stroke="#056D34"
                  strokeWidth="1"
                  strokeLinecap="round"
                  strokeDasharray="2 2"
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            >
              ...
              <div className="text-left grow">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  To deliver integrated solutions that drive business growth
                  through strategic partnerships, innovation, and unwavering
                  commitment. We provide seamless, risk-free trade setups.
                </p>
              </div>
            ...
            >
              ...
              <div className="text-left grow">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  To be a globally respected enterprise known for creating
                  value, building trust, and empowering businesses for the
                  future. We aspire to make trading fully green.
                </p>
              </div>
              <div className="absolute right-6 top-6 sm:top-auto sm:bottom-6 w-8 h-8 rounded-full bg-[#FCFCFC] border border-[#0A0A0A]/10 flex items-center justify-center text-[#0A0A0A] group-hover:bg-[#056D34] group-hover:text-white transition-all">
                <ChevronRight size={16} />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {CORE_VALUES.map((val, idx) => (
                  <div key={idx} className="flex gap-2.5 items-start">
                    <CheckCircle2
                      size={16}
                      className="text-[#0A0A0A] shrink-0 mt-1"
                    />
                    <div>
            ...
            {TIMELINE_DATA.map((evt, idx) => (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    borderColor:
                      activeTimelineIdx === idx ? "#056D34" : "#E5E7EB",
                    backgroundColor:
                      activeTimelineIdx === idx ? "#056D34" : "#FCFCFC",
                  }}
                >
                  <span
