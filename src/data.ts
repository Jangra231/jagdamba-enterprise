...
export const SERVICES_DATA: Service[] = [
  ...
  },
  {
    ...
    description:
      "Streamlined logistics and supply chain excellence for seamless operations.",
    details: [
  ...
  },
  {
    ...
    description:
      "Advanced industrial solutions tailored for efficiency, safety, and sustainable growth.",
    details: [
...
export const PRODUCTS_DATA: Product[] = [
  {
    ...
    category: "Industrial",
    description:
      "Heavy machinery, precision manufacturing tools, and industrial automation components.",
  ...
  },
  {
    ...
    description:
      "Farming tech, organic fertilizers, precision irrigation, and sustainable crop protection.",
  ...
  },
  {
    ...
    description:
      "Premium structural steel, high-grade cements, aggregate solutions, and sustainable bricks.",
  ...
  },
  {
    ...
    category: "Packaging",
    description:
      "Recyclable corrugated boxes, food-grade barrier films, and customized industrial packaging.",
  ...
  },
  {
    ...
    category: "Chemicals",
    description:
      "Certified organic compounds, solvent blends, and specialty minerals for industrial syntheses.",
  ...
  },
  {
    ...
    category: "Energy",
    description:
      "Solar panel arrays, clean energy storage systems, micro-inverters, and power grid optimization.",
...
export const TIMELINE_DATA: TimelineEvent[] = [
  ...
  },
  {
    ...
    description:
      "Expanding sustainable solutions, localizing manufacturing, and enhancing digital operations.",
    iconName: "Leaf",
  },
];
